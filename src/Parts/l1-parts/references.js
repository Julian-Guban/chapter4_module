    ...
    <div className="full-width flex-center flex-column">
      <div className="topic-container">
        ...
        <p className="overview-intro card">
          ...
          >
            <i>
              • FCIT. (n.d.). Chapter 6 on network operating systems. Retrieved
              March 5, 2025, from https://fcit.usf.edu/network/chap6/chap6.htm
            </i>
          </a>
          <br />
          <br />
          <a
            href="https://www.lenovo.com/us/en/glossary/nos/"
            rel="noreferrer"
            target="_blank"
          >
            <i>
              • Lenovo. (n.d.). Glossary: Overview of NOS features. Retrieved
              March 5, 2025, from What is a network operating system | Can NOS
          ...
          >
            <i>
              • Microsoft. (n.d.). Network Policy Server documentation.
              Retrieved March 5, 2025, from Network Policy Server (NPS) |
              Microsoft Learn
            </i>
          </a>
          <br />
