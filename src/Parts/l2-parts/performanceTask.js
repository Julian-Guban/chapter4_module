      ...
      <div className="topic-container">
        ...
        <div className="card">
          ...
          <div className="overview-intro">
            <p>
              Students will configure a DHCP (Dynamic Host Configuration
              Protocol) server, DNS (Domain Name System) server, and FTP (File
              Transfer Protocol) server for a company network. <br />
              <br />
              Each student must follow the provided instructions while using the
              designated IP address and company name.
            </p>
          ...
          <tbody>
            <tr>
              ...
              <td>
                ...
                <br />
                <br />- Ensure that client devices use the DNS server and verify
          ...
          <div className="sticky-board">
            <div className="card sticky">
              ...
              >
                ...
                <br />
                <br />
                Setting up a DHCP server ensures dynamic IP assignment,
                simplifying network management.
                <br />
                <br />
                Configuring the DNS server allows domain name resolution,
                improving accessibility and efficiency within the network.
                <br />
                <br />
                Installing and managing an FTP server provides controlled
                file-sharing capabilities, ensuring secure access and proper
                user permissions.
                <br />
                <br />
      ...
      <div className="topic-container">
        ...
        <div className="card flex-center flex-column">
          ...
          <p className="overview-intro ">
            ...
            <br />
            <br />
            Why do you think proper configuration is the crucial part in
            ensuring a smooth and secure technological experience?
            <br />
            <br />
